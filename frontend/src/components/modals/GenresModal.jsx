  ...
  return (
    <ModalContainer visible={visible} onClose={handleClose}>
      <div className="flex flex-col justify-between h-full">
        <div>
          <h1 className="dark:text-custom-gray text-primary text-2xl font-semibold text-center">
            Select Genres
          </h1>
...
const Genre = ({ children, selected, onClick }) => {
  const getSelectedStyle = () => {
    return selected
      ? "dark:bg-custom-gray dark:text-primary bg-light-subtle text-custom-gray"
      : "text-primary dark:text-custom-gray";
  };
