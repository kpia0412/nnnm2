...
const SearchResults = ({
  ...
  return (
    <div className="absolute z-50 right-0 left-0 top-10 bg-white dark:bg-secondary rounded-3xlshadow-md p-2 max-h-64 space-y-2 mt-1 overflow-auto custom-scroll-bar font-mono">
