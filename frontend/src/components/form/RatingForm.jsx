...
export default function RatingForm({ busy, initialState, onSubmit }) {
  ...
  return (
    <div>
      <div className="p-5 dark:bg-primary bg-custom-gray rounded space-y-3">
        ...
        <textarea
          ...
          className="w-full h-24 border-2 p-2 dark:text-custom-gray text-primary rounded outline-none bg-transparent resize-none"
        ></textarea>
